...
//    errorStrategy { 'retry' : 'terminate' }
    ...
    echo 'a a fter shuffling the genotypes but keeping all samples for autosomes and Z but correct numbers but only 8As and 8Bs for Z'

    Rscript ${projectDir}/scripts/PH_PopGenome_gff.R $vcf $contig $ctg_len ${params.sample_info} $bedtype ${projectDir}/R_packages ${params.gff}
