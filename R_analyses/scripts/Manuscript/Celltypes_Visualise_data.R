...
save(seurat_integrated, file = 'indata/RData/integrated_seurat_nf200_mtr0.20_gu0_cleaned.RData')
...
markers_orths <- read.xlsx("indata/markers/TDAL_CONSENSUS_MARKERS010324.xlsx", sheet = 1)[,c(1:4)] %>% 
  filter(!is.na(Confidence)) 

marker_celltypes <- read.xlsx("indata/markers/TDAL_CONSENSUS_MARKERS010324.xlsx", sheet = 2)[,c(1,2,11,13,14)]
