...
#rm_cells = c("sr5_AAGCATCTCGTGGCTG-1", "sr5_ACGTAGTAGTCAACAA-1", "sr5_CAAGGGATCTATTGTC-1", "sr5_GACCCTTAGTGTCATC-1",
#              "sr5_GACCGTGCATTGCTTT-1", "sr5_GATTCTTCACCAAATC-1", "sr5_GCATCTCGTACACTCA-1", "sr5_GGACGTCGTAGGAGGG-1", 
#              "sr5_TAAGTCGAGACATAAC-1", "sr5_TCCAGAAAGGCAGGTT-1", "sr5_TCGCACTCACGCCACA-1", "sr5_TGTTGGACACAGACGA-1",
#              "sr5_TTCGATTCAAAGGGTC-1", "st1_GGGTGAATCCGTTGGG-1")
...
if (run_type == "eval_k"){
  ...
  save(sce, sce_trad, pseudotime, counts, cellWeights, file = "sce_GAMed.RData")
} 
